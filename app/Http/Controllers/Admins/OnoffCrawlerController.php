...
use App\Services\OnoffCrawlerService;
use Illuminate\Http\Request;
use Illuminate\View\View;
use Illuminate\Http\JsonResponse;

class OnoffCrawlerController extends Controller
{
    public function __construct(
        protected OnoffCrawlerService $crawlerService
    ) {
    ...
    {
        return view('admins.onoff-crawler.index');
    }
