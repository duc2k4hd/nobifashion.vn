    ...
    <div class="nobifashion_footer_content">
        ...
        <div class="nobifashion_footer_content_company">
            ...
            <div class="nobifashion_footer_content_company_links">
                ...
                <a style="position: relative;" href="{!! $settings->dmca ?? ''  !!}" title="DMCA.com Protection Status" class="dmca-badge"> <img style="position: relative; object-fit: cover; width: 100px; max-width: 150px; height: auto;" loading="lazy" src ="{!! $settings->dmca_logo ?? ''  !!}"  alt="DMCA.com Protection Status" /></a>  <script defer src="https://images.dmca.com/Badges/DMCABadgeHelper.min.js"> </script>
