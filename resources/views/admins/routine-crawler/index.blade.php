...
@section('page-title', 'Tool Cào Routine.vn')
...
@section('content')
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold mb-1">🕷️ Tool Cào Routine.vn</h2>
            <p class="text-muted mb-0">Cào bài viết từ routine.vn và tự động viết lại bằng AI</p>
        </div>
    </div>
            ...
            <form id="crawlForm">
                ...
                <div class="mb-4">
                    ...
                    <textarea 
                        ...
                        class="form-control" 
                        rows="10" 
                        placeholder="Nhập mỗi URL danh mục trên một dòng, ví dụ:&#10;https://routine.vn/danh-muc-1&#10;https://routine.vn/danh-muc-2"
                        required
                    ></textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('{{ route("admin.routine-crawler.crawl") }}', {
                method: 'POST',
                headers: {
