        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (entityIdInput && entityIdHidden && entityTypeSelectEl) {
                ...
                function initEntityAutocomplete() {
                    ...
                    // Load current entity
                    const currentEntityId = entityIdHidden.value;
                    const currentEntityName = entityIdInput.dataset.currentName || '';
                    ...
                    tomSelect = new TomSelect(entityIdInput, {
                        ...
                        searchField: 'name',
                        create: false,
                        options: currentEntityId ? [{id: currentEntityId, name: currentEntityName}] : [],
                        items: currentEntityId ? [currentEntityId] : [],
